...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "source",
            sa.Enum("OFAC", "UN", "EU", "UK", "OTHER", name="data_source_type"),
            nullable=False,
        ),
        sa.Column(
            "entity_type",
            sa.Enum("individual", "entity", "vessel", "aircraft", name="entity_type"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "entity_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("sanctioned_entities.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "program_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("sanctions_programs.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "request_type", sa.String(20), nullable=False, server_default="single"
        ),
        sa.Column(
            "status",
            sa.Enum(
                "pending", "processing", "completed", "failed", name="screening_status"
            ),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "request_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("screening_requests.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "document_confidence", sa.Float, nullable=False, server_default="0.0"
        ),
        sa.Column("dob_confidence", sa.Float, nullable=False, server_default="0.0"),
        sa.Column(
            "nationality_confidence", sa.Float, nullable=False, server_default="0.0"
        ),
        ...
        sa.CheckConstraint(
            "match_layer >= 1 AND match_layer <= 4", name="ck_layer_range"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column("is_active", sa.Boolean, nullable=False, server_default="true"),
        sa.Column(
            "update_frequency_days", sa.Integer, nullable=False, server_default="7"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "validation_warnings", sa.Integer, nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        "ix_entity_normalized_name", "sanctioned_entities", ["normalized_name"]
    )
    ...
    op.create_index(
        "ix_document_normalized_number", "identity_documents", ["normalized_number"]
    )
    ...
    op.create_index(
        "ix_screening_result_request_id", "screening_results", ["request_id"]
    )
