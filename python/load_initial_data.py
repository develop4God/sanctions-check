...
def load_sanctions_programs(session):
    ...
    programs = [
        {
            ...
            "authority": "OFAC",
            "description": "Persons who commit, threaten to commit, or support terrorism",
        },
        {
            "code": "SDNTK",
            "name": "Specially Designated Narcotics Trafficker Kingpin Act",
            "authority": "OFAC",
            "description": "Foreign drug kingpins and their organizations",
        },
        {
            "code": "SDN",
            "name": "Specially Designated Nationals and Blocked Persons",
            "authority": "OFAC",
            "description": "General OFAC sanctions list",
        },
        {
            "code": "CYBER2",
            "name": "Malicious Cyber-Enabled Activities",
            "authority": "OFAC",
        ...
        },
        {
            ...
            "authority": "OFAC",
            "description": "Russia-related sanctions",
        },
        {
            "code": "SYRIA",
            "name": "Syria Sanctions",
            "authority": "OFAC",
            "description": "Syria-related sanctions",
        },
        {
            "code": "VENEZUELA",
            "name": "Venezuela Sanctions",
            "authority": "OFAC",
            "description": "Venezuela-related sanctions",
        },
        {
            "code": "CUBA",
            "name": "Cuba Sanctions",
        ...
        },
        {
            ...
            "authority": "OFAC",
            "description": "North Korea-related sanctions",
        },
        {
            "code": "UN-CONSOLIDATED",
        ...
        {
            "code": "UN-TALIBAN",
            "name": "UN Taliban Sanctions",
            "authority": "UN",
            "description": "Taliban and Al-Qaeda sanctions",
        },
        {
            "code": "UN-ISIL",
            "name": "UN ISIL/Da'esh Sanctions",
            "authority": "UN",
            "description": "ISIL/Da'esh and Al-Qaeda sanctions",
        },
    ]
    ...
    for prog_data in programs:
        existing = (
            session.query(SanctionsProgram).filter_by(code=prog_data["code"]).first()
        )
        if not existing:
...
def load_sample_entities(session):
    ...
    for entity_data in samples:
        existing = (
            ...
            .filter_by(
                external_id=entity_data["external_id"], source=entity_data["source"]
            )
            .first()
        )
...
def main():
    parser = argparse.ArgumentParser(
        description="Load initial data into SDNCheck database"
    )
    parser.add_argument(
        "--with-samples",
        action="store_true",
        help="Include sample entities for development",
    )
