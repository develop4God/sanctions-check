...
class TestModelImports:
    ...
    def test_import_program_models(self):
        ...
        from database.models import SanctionsProgram, EntityProgram
    ...
    def test_import_screening_models(self):
        ...
        from database.models import ScreeningRequest, ScreeningResult, ScreeningMatch
    ...
    def test_import_audit_models(self):
        ...
        from database.models import AuditLog, DataSource, DataUpdate
...
class TestDatabaseSessionProvider:
    ...
    def test_create_provider(self):
        ...
        settings = DatabaseSettings(host="localhost", port=5432, database="test_db")
...
def fastapi_app():
    ...
    try:
        ...
        provider = DatabaseSessionProvider(
            settings=DatabaseSettings(database="sdn_test_database")
        )
        provider.init()
...
def test_unit_of_work_rollback(db_provider):
    ...
    with db_provider.session_scope() as session:
        result = (
            ...
            .filter_by(external_id="ROLLBACK-TEST")
            .first()
        )
